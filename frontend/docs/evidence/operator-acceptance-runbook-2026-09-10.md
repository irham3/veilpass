...
> **Dokumen arsip — diperbarui 27 September 2026:** langkah dan status historis di bawah bukan instruksi operasional saat ini. Pemilik wallet telah menyelesaikan enrollment live dan uji login App A (dua kali) serta App B (sekali). Tiga package publik kini berada pada npm `0.2.1` dengan provenance dan [GitHub Release](https://github.com/irham3/veilpass/releases/tag/v0.2.1). Lihat [panduan demo aktif](demo-end-to-end-guide-2026-09-25.md), [verifikasi rilis](release-v0.2.1-verification-2026-09-27.md), [laporan test terbaru](test-report.md), dan [delivery status](delivery-status.md). Jangan gunakan perintah VPT, domain, deployment ID, atau status package lama dari bagian historis.
