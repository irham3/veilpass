...
// These controlled, origin-specific fixtures are part of the interactive
// product flow, not standalone search landing pages. Keeping them out of the
// index avoids duplicate content across the app-a and app-b subdomains.
export const metadata: Metadata = {
  title: "Private host demo",
