...
const subscribeToHostOrigin = () => () => {};
const getHostOrigin = () => window.location.origin;
const getServerHostOrigin = () => "Detecting host origin…";

export function HostDemo({ label, purpose, accent }: { label: string; purpose: string; accent: string }) {
